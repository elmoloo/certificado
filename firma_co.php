...
<body>
	...
	?>
   	...
   	<div class="container">
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-download"></i> <strong>Administrar ficheros</strong></strong> <a href="add/add-coordinador.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Regresar</a></div>
			<div class="card-body">
					...
					<form method="post" enctype="multipart/form-data" action="upload.php">
						<div class="form-group">
							...
							<div class="custom-file">
								...
								<label class="custom-file-label" for="customFile">Seleccionar Firma</label>
							</div>
