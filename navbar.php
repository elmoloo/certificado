...
<a class="navbar-brand" href="#">
   <img src="./assets/images/itsms.png"  width="35" height="35" alt="">
   </a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="./add/add-especialidad.php">Crear Especialidad</a>
          <a class="dropdown-item" href="./add/add-periodo-academico.php">Crear Periodo Academico</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="./add/add-listado-estudiantes.php">Asistencia</a>
        </div> 
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="./add/add-coordinador.php">Añadir Coordinador</a>
          <a class="dropdown-item" href="./add/add-facilitador.php">Añadir Facilitador</a>
          <a class="dropdown-item" href="./add/add-rector.php">Añadir Rector</a>
      ...
      <!--<li class="nav-item dropdown">
       ...
       <li class="nav-item dropdown" >
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="./add/add-pais.php">Añadir nuevo Pais</a>
          <a class="dropdown-item" href="./add/add-provincia.php">Añadir nueva Provincia</a>
           <a class="dropdown-item" href="./add/add-canton.php">Añadir nuevo Canton</a>
           <a class="dropdown-item" href="./add/add-ciudad.php">Añadir nueva Ciudad</a>
        </div>
      </li>
    </ul>
    </ul>
