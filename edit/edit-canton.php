				...
				<div class="col-sm-6">
					...
					<form method="post">
						<div class="form-group">
							<label>Nombre de Canton <span class="text-danger">*</span></label>
							<input type="int" name="nombre_cant" id="nombre_cant" class="form-control" value="<?php echo $row[0]['nombre_cant']; ?>" placeholder="Ingresa Nombre de el Canton" required>
						</div>
						<div class="form-group">
