...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($cedula_co==""){
		...
		if($insert){
			header('location:../rector.php?msg=ras');
			exit;
		}else{
			header('location:../rector.php?msg=rna');
			exit;
		}
	}
}
...
<body>
   	...
   	<div class="container">
		...
		<div class="card">
			...
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Añade Rector</strong> <a href="../add/add-curso.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Regresar</a></div>
				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"><a href="../add/add-curso.php"></i> Añadir Rector </a></button>
