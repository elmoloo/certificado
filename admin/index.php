			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center">
							<a href="../edit/edit-institucion.php?editId=<?php echo $val['id_institucion'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Editar</a> | 
							<a href="../delete/delete-institucion.php?delId=<?php echo $val['id_institucion'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this user?');"><i class="fa fa-fw fa-trash"></i> Eliminar</a>
						</td>
